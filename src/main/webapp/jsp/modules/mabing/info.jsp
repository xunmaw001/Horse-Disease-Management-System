            ...
            <div class="row breadcrumb-bar">
                ...
                <div class="col-md-6">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">马病登记</li>
                    </ol>
                </div>
            </div>
        </div>
                        ...
                        <form id="addOrUpdateForm">
                            ...
                            <!-- 本表所有字段 -->
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <div class="form-group col-md-6">
                                        <label>基本症状</label>
                                        <input style="width: 450px" id="zhengzhuangText" name="zhengzhuangText" class="form-control"
                                               v-model="ruleForm.zhengzhuangText" readonly>
                                    </div>


                                    <div class="form-group col-md-6">
                                        <label>治疗方案</label>
                                        <input style="width: 450px" id="zhiliaofanganText" name="zhiliaofanganText" class="form-control"
                                               v-model="ruleForm.zhiliaofanganText" readonly>
                                    </div>


                                    <div class="form-group col-md-6">
                                        <label>预防方案</label>
                                        <input style="width: 450px" id="yufangfanganText" name="yufangfanganText" class="form-control"
                                               v-model="ruleForm.yufangfanganText" readonly>
                                    </div>
