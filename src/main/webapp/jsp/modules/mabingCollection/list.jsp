...
<!--/Pre Loader -->
        ...
        <div id="content">
            ...
            <div class="container mt-0">
                <div class="row breadcrumb-bar">
                    <div class="col-md-6">
                        <h3 class="block-title">马病收藏管理</h3>
                    </div>
                    <div class="col-md-6">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active">马病收藏列表</li>
                        </ol>
                    </div>
                </div>
            </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        <div class="widget-area-2 lochana-box-shadow">
                            <h3 class="widget-title">马病收藏列表</h3>
    ...
    <script>
        ...
        function getDataList() {
            http("mabingCollection/page", "GET", {
                page: pageIndex,
                limit: pageSize,
                sort: sortColumn,
                order: sortOrder,
                mabingCollectionDelete: 1,
                //本表的
        ...
        function setDataRow(item, number) {
            ...
            //类型
            var mabingCollectionTypesCell = document.createElement('td');
            mabingCollectionTypesCell.innerHTML = item.mabingCollectionValue;
            row.appendChild(mabingCollectionTypesCell);
        ...
        function remove(id) {
            ...
            if (mymessage == true) {
                ...
                httpJson("mabingCollection/delete", "POST", paramArray, (res) => {
                    if(res.code == 0){
                        getDataList();
                        alert('删除成功');
                    }
        ...
        //添加
        function add() {
            window.sessionStorage.setItem("addmabingCollection", "addmabingCollection");
            window.location.href = "add-or-update.jsp"
        }
