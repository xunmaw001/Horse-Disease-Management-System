    ...
    <ul id="category">
					...
					<form class="layui-form" lay-filter="myForm">
						...
						<div class="layui-form-item">
							...
							<div class="layui-input-block">
								<input type="text" style="width: 500px" name="mabingUuidNumber" id="mabingUuidNumber" lay-verify="required" placeholder="马病编号" autocomplete="off" class="layui-input">
							</div>
						</div>
						...
						<div class="layui-form-item">
							...
							<div class="layui-input-block">
								<input type="text" style="width: 500px" name="mabingName" id="mabingName" lay-verify="required" placeholder="马病名称" autocomplete="off" class="layui-input">
							</div>
						</div>
						...
						<div class="layui-form-item">
							<div class="layui-input-block">
								<img id="mabingPhotoImg"
									 ...
									 src="../../img/avator.png">
								<input type="hidden" id="mabingPhoto" name="mabingPhoto"/>
							</div>
						</div>
						...
						<div class="layui-form-item">
							...
							<div  class="layui-input-inline" style="width: 500px">
								<select name="mabingTypes" id="mabingTypes">
						...
						<div class="layui-form-item">
							...
							<div class="layui-input-block">
								<input type="text" style="width: 500px" name="zhengzhuangText" id="zhengzhuangText" lay-verify="required" placeholder="基本症状" autocomplete="off" class="layui-input">
							</div>
						</div>
						...
						<div class="layui-form-item">
							...
							<div class="layui-input-block">
								<input type="text" style="width: 500px" name="zhiliaofanganText" id="zhiliaofanganText" lay-verify="required" placeholder="治疗方案" autocomplete="off" class="layui-input">
							</div>
						</div>
						...
						<div class="layui-form-item">
							...
							<div class="layui-input-block">
								<input type="text" style="width: 500px" name="yufangfanganText" id="yufangfanganText" lay-verify="required" placeholder="预防方案" autocomplete="off" class="layui-input">
							</div>
						</div>
						...
						<div class="layui-form-item">
							...
							<div class="layui-input-block">
								<input type="text" style="width: 500px" name="mabingClicknum" id="mabingClicknum"  lay-verify="required|integer"   placeholder="点击次数" autocomplete="off" class="layui-input">
							</div>
						</div>
		...
		<script>
            ...
            layui.use(['layer', 'element', 'carousel', 'http', 'jquery', 'form', 'upload', 'laydate'], function () {
                ...
                http.request(`mabing/session`, 'get', {}, function (data) {
                    // 表单赋值
                    form.val("myForm", data.data);
					jquery("#mabingPhotoImg").attr("src", data.data.mabingPhoto);
                });
