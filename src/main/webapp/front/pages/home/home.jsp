            ...
            <div class="ng-inmod-ini">
                ...
                <div class="ng-incontlst ng-fault ng-container ng-ai-drive1_map" aos="fade-up">
                    <div class="ng-prslist ng-fault ng-container">
                        <ul>
                            <li v-for="(item,index) in mabingList" v-bind:key="index">
                                <div class="ng-prslist-doc">
                                    <div class="ng-prslist-img" @click="jumpCheck('../mabing/detail.jsp?id='+item.id , item.aaaaaaaaaa == null?'':item.aaaaaaaaaa , item.shangxiaTypes == null?'':item.shangxiaTypes)" >
                                        <a href="#" class="ng-prsliik">
                                            <span class="ng-prsliik-ki ng-prsliik-ki_1">
                                                <img class="swiper-item" :src="item.mabingPhoto?item.mabingPhoto.split(',')[0]:''" style="height: 350px;width:100%;"/>
                                            </span>
                                    ...
                                    <div class="ng-prslist-tit" @click="jumpCheck('../mabing/detail.jsp?id='+item.id , item.aaaaaaaaaa == null?'':item.aaaaaaaaaa , item.shangxiaTypes == null?'':item.shangxiaTypes)" ><span>{{item.mabingName}}</span></div>
                                    <div class="ng-prslist-tit" v-if="item.mabingNewMoney"><span style="color: red;">{{item.mabingNewMoney}} RMB</span></div>
                                </div>
                            </li>
                        </ul>
                    </div>
        ...
        <div class="ng-inmod ng-fault ng-paddor ng-bg-assist">
            <div class="ng-inmod-ini">
                ...
                <div class="ng-incontlst ng-fault ng-container ng-ai-drive1_map" aos="fade-up">
                    <div class="ng-prslist ng-fault ng-container">
                        <ul>
                            <li v-for="(item,index) in gonggaoList" v-bind:key="index">
                                <div class="ng-prslist-doc">
                                    <div class="ng-prslist-img" @click="jumpCheck('../gonggao/detail.jsp?id='+item.id , item.aaaaaaaaaa == null?'':item.aaaaaaaaaa , item.shangxiaTypes == null?'':item.shangxiaTypes)" >
                                        <a href="#" class="ng-prsliik">
                                            <span class="ng-prsliik-ki ng-prsliik-ki_1">
                                                <img class="swiper-item" :src="item.gonggaoPhoto?item.gonggaoPhoto.split(',')[0]:''" style="height: 350px;width:100%;"/>
                                            </span>
                                            <span class="ng-prsliik-ki ng-prsliik-ki_2">
                                                <img class="swiper-item" :src="item.gonggaoPhoto?item.gonggaoPhoto.split(',')[0]:''" style="height: 350px;width:100%;"/>
                                            </span>
                                    ...
                                    <div class="ng-prslist-tit" @click="jumpCheck('../gonggao/detail.jsp?id='+item.id , item.aaaaaaaaaa == null?'':item.aaaaaaaaaa , item.shangxiaTypes == null?'':item.shangxiaTypes)" ><span>{{item.gonggaoName}}</span></div>
                                    <div class="ng-prslist-tit" v-if="item.gonggaoNewMoney"><span style="color: red;">{{item.gonggaoNewMoney}} RMB</span></div>
                                </div>
                            </li>
                        </ul>
                    </div>
