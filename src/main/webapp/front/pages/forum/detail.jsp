...
<body>
    ...
    <div id="app">
        ...
        <div v-if="detail.yuangongId" class="auth-container">
            发布人{{detail.yuangongName}}&nbsp;&nbsp;&nbsp;发布人权限：员工&nbsp;&nbsp;&nbsp;时间：{{detail.insertTime}}
        </div>
        <div v-if="detail.usersId" class="auth-container">
            ...
            <div class="message-list">
                <div class="message-item" v-for="(item,index) in dataList" v-bind:key="index">
                    ...
                    <div v-if="item.yuangongId" class="username-container">
                        <img class="avator" :src="item.yuangongPhoto">
                        <span class="username">员工：{{item.yuangongName}}</span>
                    </div>
