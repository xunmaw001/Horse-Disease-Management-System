...
public class MabingLiuyanView extends MabingLiuyanEntity implements Serializable {
	...
	public MabingLiuyanView() {

	}

	public MabingLiuyanView(MabingLiuyanEntity mabingLiuyanEntity) {
		try {
			BeanUtils.copyProperties(this, mabingLiuyanEntity);
